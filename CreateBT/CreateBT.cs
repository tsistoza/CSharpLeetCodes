...
namespace Solution
{
    ...
    {
        private static TreeNode? constructTree(int preStart, int preEnd, int postStart, int[] preorder, Dictionary<int,int> idxToNum)
        {
        ...
        public static void Main()
        {
            ...
            binaryTree.root = ConstructFromPrePost(Globals.preorder, Globals.postorder);
            binaryTree.LevelTraversal();

            binaryTree = new BinaryTree();
            binaryTree.root = ConstructFromPrePost(Globals.preorder1, Globals.postorder1);
            binaryTree.LevelTraversal();
            return;
        }
    }
