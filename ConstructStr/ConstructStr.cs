...
public static class Globals
{
    ...
    public static int repeatLimit1 = 2;
    public static string s1 = "aababab";
}
...
namespace Solution
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(obj.RepeatLimitedString(Globals.s, Globals.repeatLimit));
            Console.WriteLine(obj.RepeatLimitedString(Globals.s1, Globals.repeatLimit1));
            return;
        }
    }
}