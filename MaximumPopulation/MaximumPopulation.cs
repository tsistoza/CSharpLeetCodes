...
public static class Globals
{
    ...
    public static readonly List<List<int>> logs1 = new List<List<int>>()
    {
        new List<int> { 1950, 1961 },
        new List<int> { 1960, 1971 },
        new List<int> { 1970, 1981 }
    };
}
...
namespace Solution
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine(obj.MaximumPopulation(Globals.logs));
            Console.WriteLine(obj.MaximumPopulation(Globals.logs1));
            return;
        }
    }
}